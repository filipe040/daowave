  ...
  return (
    <div className="grid lg:grid-cols-2 gap-8">
      <div className="space-y-6">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <div>
                ...
                <div className="text-xs text-zinc-500 mt-1 leading-relaxed">
                  {eventTitle ? (
                    <>
                      Por defeito, <strong className="text-zinc-400">{eventTitle}</strong> usa o
        ...
        <div
          className={`rounded-3xl border border-white/10 bg-[#14141f] p-6 shadow-sm space-y-5 ${
            formDisabled ? "opacity-50 pointer-events-none" : ""
          }`}
        >
          <div className="flex items-center gap-2 text-[#00a0e3]">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold bg-[#14141f] text-black hover:bg-gray-100 disabled:opacity-50"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold border border-white/10 text-zinc-400 hover:bg-white/5 disabled:opacity-50"
          >
      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 overflow-hidden flex flex-col min-h-[640px]">
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
          ...
          {previewLoading && (
            <span className="text-xs text-zinc-500 animate-pulse">A atualizar...</span>
          )}
        </div>
        <div className="flex-1 bg-white/5 overflow-auto">
          {previewHtml ? (
            <iframe
              srcDoc={previewHtml}
