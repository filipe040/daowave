...
export function KpiCard({ label, value, subtitle, icon: Icon, iconColor = "text-white/40" }: KpiCardProps) {
    return (
        <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[28px] border border-white/10 p-8 flex flex-col gap-6 shadow-2xl group hover:bg-white/[0.05] transition-all duration-300">
            {Icon && (
