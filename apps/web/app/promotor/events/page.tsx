                            ...
                            render: (e) => (
                                <div className="flex items-center gap-4 py-1">
                                    <div className="w-12 h-12 rounded-xl bg-neutral-50 border border-neutral-200 flex flex-col items-center justify-center shrink-0">
                                        <span className="text-[9px] font-black text-neutral-400 uppercase leading-none">
                                    ...
                                    <div className="min-w-0">
                                        <div className="font-bold text-neutral-900 tracking-tight truncate group-hover:text-emerald-600 transition-colors">
                                            {e.title}
                                        </div>
