    ...
    return (
        <div className="p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    {eventSlug && (
                        <Link
                            ...
                            target="_blank"
                            className="inline-flex items-center gap-1.5 text-[12px] font-bold text-amber-600 hover:text-amber-700 mt-2"
                        >
                            Ver página pública
                ...
                {!canEdit && (
                    <p className="text-[12px] text-amber-600/80 font-medium max-w-xs text-right">
