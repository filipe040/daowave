    ...
    return (
        <PageShell
            ...
            actions={
                <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl text-[13px] font-bold border border-white/10 bg-white/5 text-zinc-400 hover:text-white hover:bg-white/10 transition-all active:scale-95"
                >
        ...
        >
            <div className="max-w-5xl space-y-6">
                        ...
                        return (
                            <button
                                ...
                                className={`flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-5 py-2.5 text-[13px] font-bold rounded-xl transition-all duration-300 ${isActive
                                    ? "bg-[#00a0e3] text-white shadow-lg scale-100"
                                    : "text-zinc-500 hover:text-white hover:bg-white/5 scale-95 hover:scale-100"
                                    }`}
                            >
                                <Icon className={`h-4 w-4 transition-colors ${isActive ? "text-white" : "text-zinc-500"}`} />
                                {tab.label}
                            </button>
                        );
                    })}
                ...
                <div className="rounded-3xl border border-white/10 bg-[#14141f] shadow-md overflow-hidden min-h-[400px] relative">
