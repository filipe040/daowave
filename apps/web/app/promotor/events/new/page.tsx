            ...
            <form onSubmit={handleSubmit} className="max-w-2xl">
                <div className="rounded-3xl border border-white/10 bg-[#14141f] shadow-md overflow-hidden divide-y divide-neutral-200 relative">
                    ...
                    <div className="px-6 py-5">
                        ...
                        />
                        <p className="mt-3 text-xs text-zinc-500 font-medium">Link do Evento: tickets.daowave.pt/events/<span className="text-white font-bold">{slug || "…"}</span></p>
                    </div>
                    ...
                    <div className="px-6 py-5">
                        ...
                        <input
                            ...
                            className={inputCls}
                        />
                        <p className="mt-2 text-xs text-zinc-500">Opcional. Cole o link partilhado do Google Maps — será usado no mapa da página pública.</p>
                    </div>
                    ...
                    <div className="px-6 py-5">
                        ...
                        <div className="grid sm:grid-cols-2 gap-3">
                            ...
                            >
                                ...
                                <p className="text-xs text-zinc-500 mt-1">Uma página com todos os bilhetes do evento.</p>
                            </button>
                            <button
                                type="button"
                            ...
                            >
                                ...
                                <p className="text-xs text-zinc-500 mt-1">Grid de artistas com página individual e poster (estilo festival).</p>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="px-8 py-6 bg-white/5 flex justify-end">
                        <button
                            ...
                            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-2xl text-[14px] font-bold bg-[#00a0e3] text-white hover:bg-[#0090cc] disabled:opacity-30 disabled:cursor-not-allowed transition-all shadow-md hover:-translate-y-0.5 active:scale-95"
                        >
