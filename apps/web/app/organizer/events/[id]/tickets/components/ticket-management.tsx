    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-6 py-3 rounded-xl bg-[#00a0e3] hover:bg-[#0090cc] text-white font-semibold transition-all shadow-lg shadow-purple-500/20 hover:shadow-xl hover:shadow-purple-500/30"
        >
      ...
      {ticketTypes.length === 0 ? (
        <div className="rounded-xl border border-white/10 bg-[#14141f] p-12 text-center">
          ...
          <p className="text-lg text-zinc-500 mb-2">Ainda não há tipos de bilhetes</p>
          <p className="text-sm text-zinc-500 mb-6">
            Crie o primeiro tipo de bilhete para começar a vender
          </p>
          <button
            onClick={() => setShowTypeForm(true)}
            className="inline-block rounded-xl bg-[#00a0e3] hover:bg-[#0090cc] px-6 py-3 text-sm font-semibold text-white transition-all hover:scale-105"
          >
            Criar Tipo de Bilhete
          </button>
        </div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  {type.description && (
                    <p className="text-sm text-zinc-500 mb-2">{type.description}</p>
                  )}
              ...
              {/* Lots List */}
              {(type.lots || []).length === 0 ? (
                <div className="mt-4 p-4 rounded-lg bg-neutral-100/50 border border-white/10 text-center">
                ...
                <div className="mt-4 space-y-3">
                  {(type.lots || []).map((lot: any) => {
                    ...
                    return (
                      <div
                        key={lot.id}
                        className="p-4 rounded-lg bg-neutral-100/50 border border-white/10"
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="grid sm:grid-cols-2 gap-2 text-sm text-zinc-500">
                              <div>
