  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-zinc-500">Use eventos anteriores como base para novos eventos</p>
      </div>
      ...
      {publishedEvents.length === 0 ? (
        <div className="rounded-xl border border-white/10 bg-[#14141f] p-12 text-center">
          ...
          <p className="text-lg text-zinc-500 mb-2">Ainda não há eventos publicados</p>
          ...
          {publishedEvents.map((event) => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span className="text-zinc-600 group-hover:text-zinc-500 transition-colors ml-4">
                  →
                </span>
              </div>
            </Link>
