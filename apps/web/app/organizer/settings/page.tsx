  ...
  if (!member?.organization) {
    return (
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-6 text-amber-400">
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-2xl font-bold text-white">Configurações da Organização</h1>
        </div>
        <p className="text-sm text-zinc-400 ml-11">Gerir os dados públicos e fiscais da sua organização</p>
      </div>
