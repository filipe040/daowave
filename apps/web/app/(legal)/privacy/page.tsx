export default function PrivacyPage() {
    return (
        <>
            ...
            <p>A empresa [NOME] reconhece a importância de proteger os dados pessoais, cumprindo estritamente as obrigações impostas pelo Regulamento Geral sobre a Proteção de Dados (RGPD).</p>

            <h3>1. Responsável pelo Tratamento</h3>
            <ul>
                <li><strong>Entidade:</strong> [NOME]</li>
            ...
            <p>Podes ditar o exercício destes direitos diretamente ao nosso Responsável pela Proteção de Proteção de Dados contactando [EMAIL].</p>
        </>
    );
}
