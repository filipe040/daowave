...
function InviteAcceptContent() {
    ...
    if (loading || status === "loading") {
        return (
            <div className="min-h-screen dash-shell flex flex-col items-center justify-center p-6">
    ...
    if (error || !invite) {
        return (
            <div className="min-h-screen dash-shell flex flex-col items-center justify-center p-6 text-center">
                ...
                <button
                    onClick={() => router.push("/")}
                    className="px-8 h-12 bg-neutral-100 hover:bg-neutral-200 text-white rounded-2xl font-bold transition-all"
                >
    ...
    return (
        <div className="min-h-screen dash-shell flex items-center justify-center p-6">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#00a0e3]/10 rounded-full blur-[120px] pointer-events-none" />

            <div className="relative w-full max-w-md bg-[#0c0c12] border border-white/10 shadow-md rounded-[40px] p-10 shadow-2xl overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-bl-[100px] pointer-events-none border-l border-b border-white/10" />

                <div className="flex flex-col items-center text-center">
                    <div className="w-20 h-20 rounded-3xl bg-white/5 flex items-center justify-center border border-white/10 mb-8 shadow-xl">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[11px] font-bold text-zinc-500 uppercase tracking-widest mb-6">
                    ...
                    <div className="w-full space-y-4">
                        {emailMismatch ? (
                            ...
                            <button
                                ...
                                className="w-full h-14 bg-[#00a0e3] text-white rounded-2xl font-black text-sm hover:bg-[#0090cc] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-md shadow-[#00a0e3]/25"
                            >
                                {accepting ? (
